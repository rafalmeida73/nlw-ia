      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-small text-muted-foreground">
            Lembre-se: você pode utilizar a variável <code className="text-primary">{`{transcription}`}</code> no seu prompt para adicionar o ocnteúdo do vídeo selecionado.
          </p>
        </div>
        ...
        <aside className="w-80 space-y-6">
          ...
          <form className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="transcription_promp">Prompt</Label>
              <Select>
                <SelectTrigger>
            ...
            <div className="space-y-2">
              <Label htmlFor="transcription_promp">Modelo</Label>
